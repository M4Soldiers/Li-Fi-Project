...
void EnableInterrupts(void) {
    // The specific register and bit to enable interrupts may vary
    // depending on the exact model of the TM4C microcontroller you are using.
    // The example here assumes NVIC (Nested Vectored Interrupt Controller) for Cortex-M
